...
# Calculate the cosine similarity between two text embeddings
...
# Calculate the cosine similarity between two structure embeddings
...
def get_combined_similarity(model, node1, node2, alpha=0.5):
    ...
    # Weighted average of text and structure similarities
    return alpha * text_sim + (1 - alpha) * structure_sim 
    

# Add similarity scores to the edges of the relation graph
